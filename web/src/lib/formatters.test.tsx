...
import { formatEnum, jsonTruncate, truncate, timeTag, jsonDisplay, checkboxInputTag } from './formatters';
...
describe('formatEnum', () => {
	...
	it('formats a list of values', () => {
		expect(formatEnum(['RED', 'ORANGE', 'YELLOW', 'GREEN', 'BLUE', 'VIOLET'])).toEqual('Red, Orange, Yellow, Green, Blue, Violet');
	});
